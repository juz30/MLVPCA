#' Perform Multilevel localized-variate functional principal component analysis (MLVFPCA)
#'
...
#'
#'
#' @name LMFPCA_1020_2WayNested
#' @aliases LMFPCA_1020_2WayNested
...
LMFPCA_1020_2WayNested=function (data, m, L1, L2, option = list(SmoothD = "2Diff", rho_1 = NULL,
                                                                rho1Seq = NULL, nsol = 10, FVE_M = 20, PrevPi = NULL, PrevPi_d = NULL,
                                                                maxiter = 100, eps = 0.01, verbose = FALSE, k = 3, alpha = NULL,
                                                                lambda = NULL, alphaSeq = NULL, lambdaSeq = NULL, FVE_threshold = 0.85,
                                                                nfold = 5, model = "2WayNested.spatial", levels = c(L1 = 100,
                                                                                                                    L2 = 5), rho1Seq.list = NULL, rho_1.list = NULL, alpha.list = NULL,
                                                                lambda.list = NULL, alphaSeq.list = NULL, lambdaSeq.list = NULL,
                                                                parallel = F, no_cores = 10, alphaproportion = NULL, c = NULL,
